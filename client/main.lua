...
Citizen.CreateThread(function()
	...
	for i=1, #Config.WMap, 1 do
		
		local blip = AddBlipForCoord(Config.WMap[i].x, Config.WMap[i].y, Config.WMap[i].z)
		...
		AddTextComponentString(Config.WMap[i].name)
